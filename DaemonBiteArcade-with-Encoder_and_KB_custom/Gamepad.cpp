...
int Gamepad1_::getInterface(uint8_t* interfaceCount)
{
  *interfaceCount += 1; // uses 1
  HIDDescriptor hidInterface = {
    ...
    D_HIDREPORT(sizeof(_hidReportDescriptor1)),
...
int Gamepad1_::getDescriptor(USBSetup& setup)
{
  ...
  return USB_SendControl(TRANSFER_PGM, _hidReportDescriptor1, sizeof(_hidReportDescriptor1));
}
...
bool Gamepad1_::setup(USBSetup& setup)
{
